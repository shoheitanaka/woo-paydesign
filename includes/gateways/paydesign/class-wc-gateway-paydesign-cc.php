	...
	function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'user_id_payment' => array(
				...
				'default'     => 'yes',
				'description' => __( 'Use the payment method of User ID payment.', 'woo-paydesign' ),
			),
			'emv_tds' => array(
				'title'       => __( 'EMV 3D Secure', 'woo-paydesign' ),
				'id'          => 'wc-emv-tds',
				'type'        => 'checkbox',
				'label'       => __( 'Enable EMV 3D Secure', 'woo-paydesign' ),
				'default'     => 'no',
				'description' => __( 'Use EMV 3D Secure for Credit Card.', 'woo-paydesign' )
								.__( 'In order to increase your chances of passing the 3DS, it is better to always verify your address so that you are more likely to pass the screening.', 'woo-paydesign' ),
			),
